...
//
   ...
   stage('Approval') {
            ...
            steps {
                script {
                    def deploymentDelay = input id: 'Deploy', message: 'Deploy to production?', submitter: 'amrragab,admin', parameters: [choice(choices: [Yes,No], description: 'Hours to delay deployment?', name: 'deploymentDelay')]
